...
?>
    ...
    <div style="margin-top:48px;">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(220px,1fr));gap:12px;margin-top:16px;">
            <?php
            $courses = ["Object-Oriented Programming","Web Systems & Technologies","Data Structures & Algorithms","Database Management Systems","Software Engineering Principles","Operating Systems","Computer Networks","Systems Analysis & Design"];
