...
?>
    ...
    <div style="margin-top:40px;">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:10px;margin-top:12px;">
            <?php
            $interests = ["Full-Stack Development","Backend Systems","Database Architecture","Game Development","UI/UX Design","Cybersecurity","Clean Architecture","Responsive Web Design"];
