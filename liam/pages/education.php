...
?>
    ...
    <div class="edu-entry">
        ...
        <p class="edu-year"><?php echo $edu['year']; ?> &nbsp;·&nbsp; <span style="color:var(--accent);font-size:12px;"><?php echo $edu['status']; ?></span></p>
    </div>
    ...
    <div style="margin-top:48px;">
        ...
        <div style="display:grid;grid-template-columns:repeat(auto-fill,minmax(220px,1fr));gap:12px;margin-top:16px;">
            <?php
            $courses = ["Data Structures & Algorithms","Object-Oriented Programming","Operating Systems","Computer Networks","Software Engineering","System Design","Database Management","Computer Architecture","Algorithm Analysis","Concurrency & Parallelism"];
