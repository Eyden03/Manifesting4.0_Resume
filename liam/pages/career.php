...
?>
    ...
    <div style="margin-top:40px;">
        ...
        <div style="display:flex;flex-wrap:wrap;gap:10px;margin-top:12px;">
            <?php
            $interests = ["Backend Systems","Systems Programming","Concurrency & Parallelism","Distributed Systems","Agentic AI","Network Security","Algorithm Design","Software Architecture"];
