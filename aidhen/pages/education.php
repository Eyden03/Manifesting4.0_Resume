    ...
    <?php foreach ($education as $i => $edu): ?>
        ...
        <div class="edu-entry">
            ...
            <?php if (!empty($edu['specialization'])): ?>
                <p class="edu-school" style="font-style:italic; color:var(--muted); font-size:13px;">
                    <?php echo $edu['specialization']; ?>
                </p>
            <?php endif; ?>
    ...
    <div style="margin-top: 48px;">
        ...
        <div style="display:grid; grid-template-columns: repeat(auto-fill, minmax(220px, 1fr)); gap:12px; margin-top:16px;">
            ...
            foreach ($courses as $course) {
                echo '<div style="padding:12px 16px; border-left:3px solid var(--gold); background:var(--white); font-size:13px; line-height:1.4;">'
                     . $course . '</div>';
            }
            ?>
        </div>
