...
?>
        ...
        <div class="affil-item">
            ...
            <div class="affil-details">
                ...
                <?php if (!empty($affil['desc'])): ?>
                    <p style="font-size:13px; color:var(--charcoal); margin-top:6px; line-height:1.6;">
                        <?php echo $affil['desc']; ?>
                    </p>
                <?php endif; ?>
            </div>
    ...
    <div style="margin-top: 56px;">
        ...
        <div style="display:flex; flex-direction:column; gap:0;">
            <?php
            $awards = [
                ["award" => "Best Presenter", "event" => "Design Thinking Competition, FEU Tech", "year" => "2026"],
                ["award" => "2nd Placer — Best Project", "event" => "Design Thinking Competition, FEU Tech", "year" => "2026"],
            ];
            foreach ($awards as $a) {
